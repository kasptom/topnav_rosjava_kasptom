...
public class TopicNames {
    ...
    public static final String HEAD_LINЕАR_DIRECTION_CHANGE_TOPIC = "/toponav_head_linear_direction_state";
    public static final String TOPNAV_FEEDBACK_TOPIC = "/topnav/feedback";
    public static final String TOPNAV_STRATEGY_FINISH_TOPIC = "/topnav/strategy_finish";
