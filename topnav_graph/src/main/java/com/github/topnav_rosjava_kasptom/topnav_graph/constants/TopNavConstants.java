...
public class TopNavConstants {
    ...
    public static final String TOPNAV_ATTRIBUTE_KEY_EDGE_TYPE = "topnav.edgeType";
    public static final String TOPNAV_ATTRIBUTE_VALUE_EDGE_TYPE_LEFTWARD = "topnav.edgeType.leftward";
    public static final String TOPNAV_ATTRIBUTE_VALUE_EDGE_TYPE_RIGHTWARD = "topnav.edgeType.rightward";
}
